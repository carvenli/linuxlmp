...
if [ "$version" = "LinuxLMP 0.1 CentOS" ];then
echo "========================================================================="
echo "LinuxLNMP installtion is being started" 
echo "========================================================================="
else
echo "LinuxLMP 0.1 Centos have not been installed"
exit 1
fi
}
...
echo "Which site would you upgrade to linuxlnmp?"
...
echo "Please run "sh /root/linuxlmp/nginx.sh" to upgrade website to LinuxLNMP"
echo "For more information, please visit http://bbs.73yi.net/forum-46-1.html"
echo "========================================================================="
fi